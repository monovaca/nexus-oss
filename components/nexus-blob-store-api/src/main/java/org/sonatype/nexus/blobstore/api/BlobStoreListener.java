...
public interface BlobStoreListener
{
   ...
   */
  void blobCreated(BlobId blobId, Map<String, String> headers, BlobMetrics metrics, @Nullable String message);
   ...
   * trigger this event.
   *
   * @see #blobCreated(BlobId, Map, BlobMetrics, String)
   */
  void blobAccessed(BlobId blobId, Map<String, String> headers, BlobMetrics metrics, @Nullable String message);
